...
if($num_rows==0)
{
      echo "<script>window.alert('You are not registered on our website.PLease SignUp to continue');</script>";
      /*echo "<script>window.location.href='HomePage.php';</script>";*/
      $flag=2;   
}
else 
{
     $sql="SELECT * FROM users WHERE Yr = '$yr' AND Batch = '$batch' AND RollNo = '$rollno'and  Password = SHA('$pass')";
     ...
     if($num_rows!=0)
      ...
      {echo "<script>window.alert('Oops!Invalid Credentials. Please try again.');</script>";     
      /*echo "<script>window.location.href='HomePage.php';</script>";*/  
       $flag=1;  }
